...
const { handleShareData, generatePDFAndText } = require('./saveSharescreen.js');
    ...
    mediaWs.on('message', async (data) => {
        try {
            ...
            if (msg.msg_type === 16 && msg.content && msg.content.data) {
                ...
                console.log('screen share data received');
                await handleShareData(shareData, user_id, timestamp, meetingUuid);
            }
