...
import { extractAndAccumulateTraits } from './chatWithOpenrouterForTriats.js'; // adjust path as needed
    ...
    mediaWs.on('message', async (data) => {
        try {
            ...
            if (msg.msg_type === 17 && msg.content && msg.content.data) {
                ...
                const { current: traitsCount, total } = await extractAndAccumulateTraits(msg.content.data);



                console.log("\n📊 Trait Counts (this message):", traitsCount);
