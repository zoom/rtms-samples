...
```bash
docker build -f storage/save_audio_and_video_to_local_storage_sdk/Dockerfile -t rtms-storage-save_audio_and_video_to_local_storage_sdk .
docker run --rm --env-file storage/save_audio_and_video_to_local_storage_sdk/.env -e ZM_RTMS_PORT=8080 -p 8080:8080 rtms-storage-save_audio_and_video_to_local_storage_sdk
```
