...
```bash
docker build -f storage/save_audio_and_video_to_aws_s3_storage_js/Dockerfile -t rtms-storage-save_audio_and_video_to_aws_s3_storage_js .
docker run --rm --env-file storage/save_audio_and_video_to_aws_s3_storage_js/.env -p 3000:3000 rtms-storage-save_audio_and_video_to_aws_s3_storage_js
```
