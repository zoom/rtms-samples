...
let frameCounter = 0; // Initialize this outside your message handler
    ...
    mediaWs.on('message', async (data) => {
        try {
            ...
            if (msg.msg_type === 15 && msg.content && msg.content.data) {
                frameCounter++; // Increment for each incoming frame
              
                if (frameCounter % 50 === 0) {
                    console.log("frameCounter % 50");
                    try {
                        ...
                        console.error(`Error on frame ${frameCounter}:`, err);
                    }
                }
            }
