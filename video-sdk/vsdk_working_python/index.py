...
def connect_to_media_ws(media_url, session_id, stream_id, signaling_socket):
    ...
    def on_close(ws, close_status_code, close_msg):
        ...
        if session_id in active_connections:
            active_connections[session_id].pop("media", None)
    ...
    ws = websocket.WebSocketApp(media_url,
                                ...
                                on_error=on_error,
                                on_close=on_close)
    active_connections[session_id]["media"] = ws
...
def handle_webhook():
    ...
    if event == "session.rtms_started":
        ...
        connect_to_signaling_ws(session_id, stream_id, server_url)
