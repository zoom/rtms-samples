...
public class RmsService {
    ...
    private static final Logger log = LoggerFactory.getLogger(RmsService.class);
    ...
    public void connectToSignalingWebSocket(RtmsConnection conn) {
        ...
        try {
            ...
            log.info("🔐 Signaling OkHttp WebSocket SSL verification disabled");
            ...
            log.info("[Signaling] OkHttp WebSocket instance created successfully, SSL verification disabled");
    ...
    public void connectToMediaWebSocket(RtmsConnection conn, String mediaUrl, String sessionID, String streamId,
        ...
        try {
            log.info("🔐 Media OkHttp WebSocket SSL verification disabled");
            ...
            log.info("[Media] WebSocket instance created successfully, SSL verification disabled");
    ...
    private OkHttpClient createOkHttpClient() throws Exception {
        ...
        X509TrustManager trustAllCerts = new X509TrustManager() {
            public X509Certificate[] getAcceptedIssuers() {
                return new X509Certificate[0]; // Must return empty array, not null
            }
