...
```bash
docker build -f transcript/save_transcript_js/Dockerfile -t rtms-transcript-save_transcript_js .
docker run --rm --env-file transcript/save_transcript_js/.env -p 3000:3000 rtms-transcript-save_transcript_js
```
