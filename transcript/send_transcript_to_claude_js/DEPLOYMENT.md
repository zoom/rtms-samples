...
to `transcript/send_transcript_to_claude_js/render.yaml`. The Blueprint builds
...
`transcript/send_transcript_to_claude_js/railway.json`. Add the variables from
