...
Internal MCP service that sends transcript batches to Anthropic, OpenAI, or OpenRouter and exposes only the explicitly allowed tools discovered from MCP servers declared in `MCP_SERVERS_JSON`.
